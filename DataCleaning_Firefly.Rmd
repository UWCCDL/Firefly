...
#  select("screen_name", "userId", "lessonTitle", "answer", "factId", #"alpha")
...
#viewing average sof for facts with no prior knowledge

unknown_sof <- prior_knowledge_alldata %>%
  filter(prior_knowledge == "yes" & (lessonTitle == "Asian Flags" | lessonTitle == "Caribbean Flags")) %>%
  group_by(userId, lessonTitle) %>%
